...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-09-2023 a las 09:26:11
...
--
-- Estructura de tabla para la tabla `deuda_pago`
--
...
--
-- Indices de la tabla `deuda_pago`
--
ALTER TABLE `deuda_pago`
  ADD PRIMARY KEY (`deuda`),
  ADD KEY `id_pago` (`id_pago`);
...
--
-- Filtros para la tabla `deuda_pago`
--
ALTER TABLE `deuda_pago`
  ADD CONSTRAINT `deuda_pago_ibfk_1` FOREIGN KEY (`id_pago`) REFERENCES `pagos` (`id_pago`),
  ADD CONSTRAINT `deuda_pago_ibfk_2` FOREIGN KEY (`deuda`) REFERENCES `deuda_pendiente` (`id`);
...
--
ALTER TABLE `divisa`
  ADD CONSTRAINT `divisa_ibfk_1` FOREIGN KEY (`id_detalles_pagos`) REFERENCES `detalles_pagos` (`id_detalles_pagos`);
...
ALTER TABLE `servicios_pagos`
  ...
  ADD CONSTRAINT `servicios_pagos_ibfk_2` FOREIGN KEY (`id_pago`) REFERENCES `pagos` (`id_pago`);
